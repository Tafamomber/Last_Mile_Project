#Main GUI code with taffic GUI and weather GUI in it:
...
# Add padding to ensure the boxes are not touching each other
padding_val = 10
...
week_date_label = ttk.Label(week_date_bar, text="Week / Date", anchor="center")
