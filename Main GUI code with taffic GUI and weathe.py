...
traffic_frame = tk.Frame(root, relief="solid", bg="white")  # Removed padding
traffic_frame.grid(row=1, column=0, sticky="nsew", padx=padding_val, pady=padding_val)  # Added padx/pady for spacing
